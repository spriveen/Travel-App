    ...
    bg-cover bg-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl`}>
     ...
     p-6 lg:px-20 lg:py-10">
      <div className="flexCenter gap-4">
        <div className="rounded-full bg-green-800 p-4">
          <Image
           src="/folded-map.svg"
           alt="map"
           width={28}
...
const Camp = () => {
  return (
    ...
    relative flex flex-col py-10 lg:mb-10
    lg:py-20 xl:mb-20'>
     <div className='hide- flex h-[340px] w-full items-start
     justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
     <CampSite 
        backgroundImage="bg-bg-img-1"
        title="Wilderness Spot"
